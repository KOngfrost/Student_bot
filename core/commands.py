...
COMMANDS_HOUSING = (
    ...
    "Жыл-быт", "жыл-быт",
    "Жылбыт", "жылбыт",
    "Жилищно-бытовой", "жилищно-бытовой",
    "Жилищно-бытовой отдел", "жилищно-бытовой отдел",
)
COMMANDS_CULTURE = (
    "Культмасс", "культмасс",
    "Культ-масс", "культ-масс",
    "Культурно-массовый", "культурно-массовый",
    "Культуро-массовый", "культуро-массовый",
    "Культурно-массовый отдел", "культурно-массовый отдел",
    "Културно-мвссовый", "културно-мвссовый",
)
COMMANDS_INFORMATION = (
    "Информ", "информ",
    "Информационный", "информационный",
    "Информационный отдел", "информационный отдел",
)
COMMANDS_CORPORATE = (
    "Корпоративный", "корпоративный",
    "Корп", "корп",
    "Корпоративный отдел", "корпоративный отдел",
)
