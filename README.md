...
[![Security Audited](https://img.shields.io/badge/security-SEC--01..12%20passed-success.svg)](SECURITY.md)
...
*Проект поддерживается объединённой командой Студенческого совета университета. Версия 0.8.8.2.*
