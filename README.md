...
- 📱 **Планы развития и мобильное приложение Android**: подготовлена детальная архитектура и дорожная карта нативного клиента на Kotlin + Jetpack Compose ([docs/PLANS.md](docs/PLANS.md)).
