...
## 🔑 Ключевые возможности v0.7.8

- 🎨 **Современный UI**: тёмная графитовая тема с неоновым акцентом (`#ff4d9d`), адаптивный сайдбар, мобильное меню, живой поиск и фильтры по статусам без перезагрузки страниц.
