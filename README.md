...
│   ├── reporting.py           # Генерация стандартизированных 5-страничных Excel-отчётов
...
- 📱 **Планы развития (Android App, Telegram Bot, Telegram Mini App)**: подготовлена детальная архитектура и дорожная карта нативного клиента на Android, а также Telegram-бота и интерактивного Telegram Mini App ([docs/PLANS.md](docs/PLANS.md)).
